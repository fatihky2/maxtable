...
//#define		BLOCK_MAX_COUNT		(BLK_CNT_IN_SSTABLE * SSTABLE_MAX_COUNT + 3)	
#define               BLOCK_MAX_COUNT         (BLK_CNT_IN_SSTABLE * SSTABLE_MAX_COUNT + 2)    
